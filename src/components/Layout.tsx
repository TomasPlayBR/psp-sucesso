...
import { Shield, Users, AlertTriangle, ScrollText, LogOut, Star, Radio, Home, Target, ClipboardList, Lock } from "lucide-react";
        ...
        <nav className="flex items-center gap-1 px-6 pb-0 border-t overflow-x-auto"
          ...
          {currentUser && (
            <>
              ...
              <NavLink to="/detidos" className={navLinkClass}>
                <Lock size={14} />
                Detidos
              </NavLink>
            </>
